...
?>
		<div class="slide" style="width:<?=$_POST['image_width']?>px; height:<?=$_POST['image_height']?>px; float:left;"><img align="left" src="<?=$img['src']?>" width="<?=$_POST['image_width']?>" height="<?=$_POST['image_height']?>" /></div>
<?		
	}
	else exit('No Images');
?>
