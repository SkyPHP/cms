...
?>
	<div style="margin-bottom:5px;">
		<input type="radio" value="" id="all_<?=$filter?>" name="<?=$filter?>" class="phrase-filter-radio" style="margin-left:2px;" /> <label style="cursor:pointer;" for="all_<?=$filter?>">ALL</label>
    </div>
<?
	if($rs) while (!$rs->EOF) {
?>
