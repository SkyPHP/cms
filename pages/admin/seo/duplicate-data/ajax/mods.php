<?
	...
	$mods = aql::select("dup_modifier { id as mod_id, lower(phrase) as lower_phrase, phrase order by order by sub_category, phrase }", array('dup_modifier'=>array('where'=>$where)));
