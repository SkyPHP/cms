...
?>
	<div class="has-floats" style="margin-top: 20px;">
    	...
    	<div style="float:left; font-weight:bold;">Order <input type="radio" name="auto-switch" value="man" <?=$man?>> Manual&nbsp;&nbsp;&nbsp;<input type="radio" name="auto-switch" value="auto"> Auto</div>
	</div>
<?
