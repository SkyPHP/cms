	...
	*/
	...
	return  {
		init: function(callback) {
			...
			aql._callback(callback, cnt, cnt);
		...
		setMarkerClick: function(marker, loc) {
			google.maps.event.addListener(marker, 'click', function() {
				...
				var content = '<div class="gmaps-content">';
				content += '<div class="gmaps-content-title">' + loc.title + '</div>';
				if (loc.html) content += '<div class="gmaps-content-small-desc">' + loc.html + '</div>';
				content += '</div>';
