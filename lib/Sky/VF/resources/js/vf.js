    ...
    vf = {
        slideshow: function($div, params) {
            ...
            var that = {
                ...
                mainImageContainer : $('.vf-slideshow-image', $div), // w * n
            ...
            return {
                setWidth : function() {
                    ...
                    $('img', that.mainContainer).each(function(i) {
                        //w += $(this).width();
                        w += parseInt(that.container.attr('w')); // new
                        if (i === 0) {
                            $div.width(that.container.attr('w')); // new
                            that.container.width(w);
                            that.mainContainerWidth = w;
                            //that.mainContainer.height($(this).height());
                            that.mainContainer.height(that.container.attr('h'));
                        }
        ...
        uploader : function($div, params) {
            ...
            return {
                ...
                bindToUploader : function() {
                    ...
                    $('.vf-uploader-remove').on('click', function() {
